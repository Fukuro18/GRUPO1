...
import ec.edu.uce.appproductos.ui.passwordhash.PasswordHashScreen
...
fun AppNavigation() {
    ...
    NavHost(navController = navController, startDestination = "login") {
        composable(
            ...
            LoginScreen(
                onLoginSuccess = { userName, password -> navController.navigate("passwordHash/$userName/$password") },
        ...
        composable(
            route = "passwordHash/{userName}/{password}",
            arguments = listOf(
